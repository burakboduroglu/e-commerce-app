...
function Detail({product}) {
    return ( 
        <div className="main">
			<div className="product-container bg-blue-gray-900">
					...
					<div className="product-right-content">
						...
						<div className="price-and-rating">
							...
							<div>
								<a href="#reviews">
									...
									<p className="rating-text"><span className="rating-number"></span> ratings</p>
								</a>
							</div>
						</div>
						<div className="add-to-cart-form">
							...
							<button type="button" className="add-to-cart">
								<img src="../img/cart.svg" className="cart-svg" alt="" />
								<p>Add To Cart</p>
							</button>
						</div>
					</div>
